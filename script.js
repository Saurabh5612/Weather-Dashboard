...
var getLocationWeather = function (location) {
    ...
    var apiUrl = "https://api.openweathermap.org/data/2.5/weather?q=" + location + "&cnt=7&APPID=859703ec2c35d55d411c037402bef9ad";
...
var getLatandLon = function (weather) {
    ...
    var apiUrl = "https://api.openweathermap.org/data/2.5/onecall?lat=" + latVal + "&lon=" + lonVal + "&cnt=5&exclude=hourly&appid=859703ec2c35d55d411c037402bef9ad";
